  ...
  public sections = [
    {
      ...
      children: [
        ...
        {
          name: 'The Pull Request Submit Process'
        },
        {
          name: 'Marking Unfinished Pull Requests'
        },
        {
          name: 'Marking Unfinished Pull Requests'
        }
    ...
    },
    {
      ...
      children: [
        {
          name: 'Pull Requests and the Release Cycle'
        },
        {
          name: 'How the e2e Tests Work'
        },
        {
          name: 'Why was my pull request closed?'
        },
        {
          name: 'Why was my pull request closed?'
        },
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: 'Why is my pull request not getting reviewed?'
        },
        {
          name: 'Comments Matter'
        },
        {
          name: 'Commit Message Guidelines'
        },
        {
          name: 'Is the feature wanted? File a Kubernetes Enhancement'
        }
      ]
    },
    {
